...
public class ModelTurret extends ModelBase {
    ...
    public ModelTurret() {
        ...
        this.LeftPlateInner.addBox(0.0F, -4.0F, -2.0F, 4, 8, 4, 0.0F);
        this.RightPlate = new ModelRenderer(this, 30, 16);
        this.RightPlate.setRotationPoint(-2.5F, -6.0F, 0.0F);
        this.RightPlate.addBox(-5.0F, -5.0F, -3.0F, 1, 10, 6, 0.0F);
        ...
        this.LeftPlate.addBox(4.0F, -5.0F, -3.0F, 1, 10, 6, 0.0F);
        ...
        this.RightPlateInner.addBox(-4.0F, -4.0F, -2.0F, 4, 8, 4, 0.0F);
