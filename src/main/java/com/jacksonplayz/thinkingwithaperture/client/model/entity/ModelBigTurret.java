...
public class ModelBigTurret extends ModelBase {
    ...
    public ModelBigTurret() {
        ...
        this.RightPanel2.addBox(0.0F, -5.0F, -3.5F, 4, 10, 7, 0.0F);
        ...
        this.LeftPanel2.addBox(-4.0F, -5.0F, -3.5F, 4, 10, 7, 0.0F);
        this.RightPanel1 = new ModelRenderer(this, 0, 27);
        this.RightPanel1.setRotationPoint(-4.0F, -7.0F, 0.0F);
        this.RightPanel1.addBox(-2.0F, -6.0F, -4.5F, 2, 12, 9, 0.0F);
        ...
        this.LeftPanel1.addBox(0.0F, -6.0F, -4.5F, 2, 12, 9, 0.0F);
