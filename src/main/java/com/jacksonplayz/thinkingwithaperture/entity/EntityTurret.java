...
public class EntityTurret extends EntityLiving
{
    ...
    {
        NORMAL("normal", 0.8F, 1.5F, 1.0f, 0.0f, null, ModSounds.TURRET_HURT, ModSounds.TURRET_DEATH), FAT("fat", 1.6F, 1.7F, 0.925F, 0.0f, null, ModSounds.BIG_TURRET_HURT, ModSounds.BIG_TURRET_DEATH), DEFECTIVE("defective", 0.8F, 1.5F, 1.0f, 0.0f, null, ModSounds.DEFECTIVE_TURRET_HURT, ModSounds.DEFECTIVE_TURRET_DEATH), ORACLE("oracle", 0.8F, 1.5F, 1.0f, 0.0f, ModSounds.ORACLE_TURRET_AMBIENT, ModSounds.ORACLE_TURRET_HURT, ModSounds.ORACLE_TURRET_DEATH);
